...
//				break;
	...
	void Update()
	{
        /*
        //=============================================---add
        Debug.Log("player1avatars" + Player1Avatars.Count);
        if (Checkunityspawn.count == 1)
        {
            KinectInitialized = false;
            Player1Calibrated = false;
            Player2Calibrated = false;
            AllPlayersCalibrated = false;
//    	    Player1Controllers = null;
//    	    Player2Controllers = null;
            Awake1();
            Checkunityspawn.count++;
        }
//        if (Checkunityspawn.spawn == 1)
//        {
//            Player1Avatars = null;
//            Player2Avatars = null;
//        }
        //AllPlayersCalibrated = false;==================================================finish
        */
        if (KinectInitialized)
		{
			...
			if(Player1Calibrated)
			{
				foreach (AvatarController controller in Player1Controllers)
				{
					//if(controller.Active)
					{
                        ...
                        /*
//add----------------------------------------
//                        Debug.Log(Player1ID + "updateavatar avatar controller");
                        if (Checkunityspawn.count == 2) {
						    controller.UpdateAvatar(Player1ID);
                        }
                        if (Checkunityspawn.spawn == 1)
                        {
...
*/
			...
			{
                Debug.Log("player2 was calibrated");
