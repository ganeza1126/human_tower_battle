...
//moshi umaku ikanai nara kesu sita no itigyouwo 
[RequireComponent(typeof(Animator))]
public class Avaterdata : MonoBehaviour {
...
/*    private void Start()
    ...
    //        //new ver(miss)
    //	    KinectWrapper.NuiSkeletonFrame skeletonFrame;
    ...
    //						};
    //
    //		KinectWrapper.NuiSkeletonData skeletonData = skeletonFrame.SkeletonData[0];
    //		uint userId = skeletonData.dwTrackingID;

    Done(KinectManager.playerid);
        Debug.Log("playerid ga yobareta");
//        SceneManager.UnloadSceneAsync("additive");
        Debug.Log("additive ga kesareta");
        //finish==============================================
	}
    */
